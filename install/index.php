...
class Installer extends Symphony
{
    ...
    {
        Configuration::setDirectory('/install/conf');
        Configuration::environment(''); // Empty string as we don't have one
...
Configuration::setDirectory('/install/conf');
$mainConf = Configuration::read('main');
$databaseConf = Configuration::read('database');
...
if (isset($_POST['action']['install'])) {
    ...
    if ($errors->length() == 0) {
        ...
        if ($errors->length() == 0) {
            ...
            Configuration::setDirectory('/app/config');
            Configuration::environment('default');
            Configuration::create($mainConf, 'main');
            Configuration::create($databaseConf, 'database');
        }
