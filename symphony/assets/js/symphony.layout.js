/*---------------------------------------------------------------------------*/
    ...
    /*-----------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------*/
            ...
            object
                .on('layout-initialize', '> .layouts > *', function() {
                ...
                .on('layouts-hide', '> .layouts', function() {
                    jQuery(this).hide();
                })

                .on('layouts-show', '> .layouts', function() {
                    jQuery(this).show();
                })

                .on('layout-select', '> .layouts > *', function() {
                    var layout = jQuery(this);
        ...
        /*-------------------------------------------------------------------*/
            ...
            object
                .on('column-initialize', '> .columns > *', function() {
                    var column = jQuery(this);
        ...
        /*-------------------------------------------------------------------*/
            ...
            object
                .on('fieldset-initialize', 'fieldset', function() {
                ...
                .on('fieldset-refresh', 'fieldset', function() {
                    var fieldset = jQuery(this);
                ...
                .on('fieldset-remove', 'fieldset', function() {
                    var fieldset = jQuery(this);
                ...
                .on('fieldset-change', 'fieldset', function() {
                    var fieldset = jQuery(this);
        ...
        /*-------------------------------------------------------------------*/
            ...
            object
                .on('click', '.controls .choose', function() {
                ...
                // Show fieldset menu:
                .on('click', '.columns .column fieldset .controls .add', function() {
                    var fieldset = jQuery(this).closest('fieldset'),
                        element = jQuery('<fieldset />');

                    element.insertAfter(fieldset);
                    element.trigger('fieldset-initialize');
                })

                // Remove fieldsets and fields:
                .on('click', '.columns .column fieldset .controls .remove', function() {
                    jQuery(this)
                        .closest('fieldset')
