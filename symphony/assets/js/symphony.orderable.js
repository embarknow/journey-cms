...
-----------------------------------------------------------------------------*/
    ...
    jQuery(document).ready(function() {
        ...
        $(document)
            .on('orderable-start', '.orderable-widget .orderable-handle', start)
            .on('orderable-move', '.orderable-widget .orderable-handle', move)
            .on('orderable-stop', '.orderable-widget .orderable-handle', stop)

            // Click actions:
            .on('mousedown', '.orderable-widget .orderable-handle', function(event) {
                $(this).trigger('orderable-start');

                return false;
            })

            .on('mousemove', '.orderable-widget .orderable-handle', function(event) {
            ...
            .on('mouseup', '.orderable-widget .orderable-handle', function(event) {
