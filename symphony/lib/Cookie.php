...
class Cookie
{
    ...
    {
        if (
            isset($_SESSION[$this->_index])
            && is_array($_SESSION[$this->_index])
            && array_key_exists($name, $_SESSION[$this->_index]) === false
        ) {
            return null;
        }
    ...
    {
        if (
            isset($_SESSION[$this->_index]) === false
            || is_array($_SESSION[$this->_index]) === false
            || empty($_SESSION[$this->_index])
        ) {
            return null;
        }
