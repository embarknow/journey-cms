...
abstract class DataSource
{
    ...
    // Abstract function
    abstract public function render(ParameterPool $ParameterOutput);
    ...
    public static function prepareFilterValue($value, ParameterPool $ParameterOutput = null, &$filterOperationType = DataSource::FILTER_OR)
    {
